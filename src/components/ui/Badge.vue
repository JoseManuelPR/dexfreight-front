...
const variants = {
  light: {
    ...
    info: 'bg-orange-50 text-orange-500 dark:bg-orange-500/15 dark:text-orange-500',
  ...
  solid: {
    ...
    info: 'bg-orange-500 text-white dark:text-white',
...
const colorStyles = computed(() => variants[props.variant][props.color as keyof typeof variants[typeof props.variant]])
</script>
